...
export default function Home() {
  ...
  const joint_pos = {
    ...
    j1:{x:0,y:0,z:0},
    j2:{x:0,y:0.2433,z:0},
    j3:{x:0,y:0.28005,z:0},
    j4:{x:0.01015,y:0.245,z:0},
    j5:{x:0,y:0,z:0},
    j6:{x:0.057,y:0,z:0},
    j7:{x:0,y:0,z:0.2},
  }
...
const Assets = ()=>{
  return (
    <a-assets>
      ...
      <a-asset-items id="j1" src="Gen3Lite_j0.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="Gen3Lite_j1.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="Gen3Lite_j2.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="Gen3Lite_j3.gltf" ></a-asset-items>
      <a-asset-items id="j5" src="Gen3Lite_j4.gltf" ></a-asset-items>
      <a-asset-items id="j6" src="Gen3Lite_j5.gltf" ></a-asset-items>
      <a-asset-items id="j6_1" src="Gen3Lite_j5_1.gltf" ></a-asset-items>
      <a-asset-items id="j6_2" src="Gen3Lite_j5_2.gltf" ></a-asset-items>
    </a-assets>
  )
}
